      ...
      <div className="messages-output">
        {user && user.isBanned && (
          <div className="alert alert-danger">
            Your account is banned. Please contact an admin immediately, and
            click the button upon admin's approval.{' '}
            <Button
              variant="danger"
        ...
        {user && !user.isBanned && !privateMemberMsg?._id && (
        ...
        {user && privateMemberMsg?._id && (
          <>
            <div className="alert alert-info converstation-info">
              Your converstation with {privateMemberMsg.name}{' '}
              <img
                src={privateMemberMsg.picture}
                className="converstation-profile-pic"
              />
            </div>
          </>
        )}
